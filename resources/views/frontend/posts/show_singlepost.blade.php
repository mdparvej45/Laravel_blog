		...
		<div class="container-xl">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="blog-single.html#">{{ $post->category->title }}</a></li>
                    ...
                    <div class="post post-single">
						...
						<div class="post-header">
							...
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="blog-single.html#"><img style="border-radius: 50%; width:30px; height:30px;" src="https://api.dicebear.com/5.x/initials/svg?seed={{ $post->user->name }}" class="author" alt="author"/>{{ $post->user->name }}</a></li>
								@if ($post->type)
                                <li class="list-inline-item"><a href="#">{{ $post->type }}</a></li>
                                @endif
