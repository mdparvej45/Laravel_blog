    ...
    <body class="main">
        ...
        <div class="d-flex">
            ...
            <nav class="side-nav">
                ...
                {{-- Include side barrrrr --}}
                @include('layouts.backendsidebarapp')
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    ...
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    <a href="{{route('frontend.index')}}" target="_blank" class=" btn btn-primary btn-sm website">View Website</a>
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-pill overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-bs-toggle="dropdown">
                            <img alt="Rubick Tailwind HTML Admin Template" class="border border-primary" src="https://api.dicebear.com/5.x/micah/svg">
                        </div>
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                                <li class="p-2">
                                    <div class="fw-medium text-white">{{ auth()->user()->name }}</div>
                                    <div class="fs-xs text-theme-28 mt-0.5 dark-text-gray-600">CEO | Web Developer</div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class=" text-white dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover" href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                                  document.getElementById('logout-form').submit();"> <i data-feather="toggle-right" class="w-4 h-4 me-2"></i> Logout </a>
